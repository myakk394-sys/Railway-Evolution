 ...
 *
 * NOTE (1.18.2): ArmorItem uses EquipmentSlot (not ArmorItem.Type which was added in 1.20).
...
public class ModItems {
     ...
     *
     * NOTE (1.18.2): Constructor is ArmorItem(material, EquipmentSlot, Properties)
